...
```java
	...
	public static void main(String[] args) {
		...
		sc.close();
------------------------------------------------------------------------------------------
		문자열 s1과 s2의 "apple"은 id가 같습니다. s1이 만들어 둔 것을 s2가 같이 활용하는데, s3는 새로운 공간에 "apple"을 만들어 가리킵니다. s4의 "apple"은 입력을 받아야 하기에 사용자가 "apple"을 입력할지 다른 문자를 입력할지 알 수 없으니 또 다른 공간을 만들어내어 입력받은 값을 넣습니다. 그러니 s1과 s2는 같아 true가 나오고 s1과 s3, s1과 s4의 관계는 바라보는 저장공간이 다르기에 false가 나오게 됩니다.
